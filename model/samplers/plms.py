"""SAMPLING ONLY."""
# based on: https://github.com/Stability-AI/stablediffusion/blob/main/ldm/models/diffusion/plms.py
...
class PLMSSampler(object):
    ...
    def sample(self,
        ...
        self.make_schedule(ddim_num_steps=self.model.sampling_timesteps, ddim_eta=eta, verbose=verbose)
       
        samples, intermediates = self.plms_sampling(imgs,
                                                    cond,
    ...
    @torch.no_grad()
    def plms_sampling(self, img, cond,
                      ddim_use_original_steps=False,
                      timesteps=None, 
                      log_every_t=100,
                      dynamic_threshold=None):
        ...
        iterator = tqdm(time_range, desc='PLMS Sampler', total=total_steps, disable=not self.pbar)
        old_eps = []
    ...
    @torch.no_grad()
    def p_sample_plms(self, x, cond, t, index, repeat_noise=False, use_original_steps=False, 
        ...
        def get_model_output(x, t):
            ...
            return self.model.apply_model(x_in, t)
